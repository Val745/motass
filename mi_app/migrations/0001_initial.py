...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('servicio', models.CharField(choices=[('CV', 'Consulta Veterinaria'), ('BP', 'Baño y peluquería'), ('VA', 'Vacunación'), ('TV', 'Telemedicina'), ('TVJ', 'Trámites de viaje'), ('OT', 'Otro servicio')], default='CV', max_length=3, verbose_name='Tipo de servicio')),
                ('fecha', models.DateField(verbose_name='Fecha')),
                ('hora', models.TimeField(verbose_name='Hora')),
                ('notas', models.TextField(blank=True, null=True, verbose_name='Notas adicionales')),
                ('creado_en', models.DateTimeField(auto_now_add=True, verbose_name='Fecha de creación')),
                ('usuario', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='citas_usuario', to=settings.AUTH_USER_MODEL, verbose_name='Usuario')),
                ('mascota', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='citas', to='mi_app.mascota', verbose_name='Mascota')),
            ],
            options={
                'verbose_name': 'Cita',
                'verbose_name_plural': 'Citas',
                'ordering': ['-fecha', '-hora'],
                'permissions': [('puede_agendar_cita', 'Puede agendar citas')],
            },
        ),
    ]
